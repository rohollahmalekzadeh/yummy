...
export const buttonBase =
  'flex justify-center items-center cursor-pointer text-xl bg-orange-500 text-slate-100 hover:text-orange-500 hover:bg-orange-100  p-1 px-3 rounded-md active:text-slate-100 active:bg-orange-500 transition duration-300 focus:outline-none hover:shadow-orange-400 hover:shadow-lg '
